...
__all__ = [
    'SVEPhoneme', 'SpeechVoicePriority', 'SPPS_Noncontent',
    'DISPID_SABIEventBias', 'DISPID_SASNonBlockingIO',
    'DISPID_SRCEEnginePrivate', 'SAFT16kHz16BitStereo', 'SPRULESTATE',
    'SPDKL_LocalMachine', 'SDTLexicalForm', 'SpeechTokenContext',
    'DISPID_SpeechLexicon', 'SPRST_ACTIVE', 'eLEXTYPE_PRIVATE17',
    'SPFM_CREATE', 'ISpObjectToken', 'SRESoundEnd',
    'SpeechRecoContextState', 'SWPUnknownWordUnpronounceable',
    'SPDKL_CurrentConfig', 'DISPID_SPEEngineConfidence',
    'SPXRO_Alternates_SML', 'DISPID_SRCState', 'SpeechInterference',
    'DISPID_SRRTimes', 'SLTUser', 'SP_VISEME_5', 'SREAllEvents',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFT48kHz8BitMono',
    'SpeechDiscardType', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    ...
    'SPEI_PHONEME', 'SPEI_ADAPTATION', 'SGDSInactive', 'SPEI_MAX_TTS',
    'ISpeechLexicon', 'WAVEFORMATEX', 'DISPID_SRRSetTextFeedback',
    'DISPID_SpeechObjectTokenCategory', 'SPEI_TTS_PRIVATE',
    'eLEXTYPE_PRIVATE10', 'SSFMCreate',
    'DISPID_SpeechLexiconPronunciation', 'ISpeechPhraseProperties',
    'SPEI_TTS_BOOKMARK', 'DISPID_SRGetPropertyNumber',
    'ISpObjectWithToken', 'SVSFDefault',
    'DISPID_SLGetGenerationChange', 'SP_VISEME_2',
    'DISPID_SVAlertBoundary', 'SPFM_NUM_MODES', 'ISpeechPhraseRule',
    'DISPID_SRRAlternates', 'DISPID_SVSLastBookmark',
    'DISPID_SOTs_NewEnum', 'DISPID_SPAsCount', 'eLEXTYPE_RESERVED7',
    'SP_VISEME_21', 'DISPID_SPAs_NewEnum', 'SPSHT_NotOverriden',
    'ISpeechMemoryStream', 'DISPID_SPRText',
    'SpeechEmulationCompareFlags', 'SAFT16kHz8BitStereo',
    'DISPID_SRRAudioFormat', 'SVSFUnusedFlags', 'SPPS_RESERVED1',
    'SGRSTTWildcard', 'SPAS_STOP', 'STSF_FlagCreate', 'SP_VISEME_0',
    'DISPID_SRGCmdSetRuleState', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPEI_SR_AUDIO_LEVEL', 'SpFileStream', 'DISPID_SPRuleId',
    'DISPID_SpeechAudio', 'DISPID_SPELexicalForm',
    'SpeechCategoryRecoProfiles', 'SpMMAudioOut',
    'SRTExtendableParse', 'SpeechRunState', 'DISPID_SPPConfidence',
    'SpeechVoiceSkipTypeSentence', 'SAFT16kHz8BitMono',
    'SVSFParseSsml', 'DISPID_SGRSTRule', 'SVSFIsXML',
    'SPPARTOFSPEECH', 'DISPID_SGRInitialState', 'ISpNotifyTranslator',
    'SDKLCurrentConfig', 'SAFT22kHz8BitMono',
    'DISPID_SOTGetDescription', 'SRERecognition', 'SPSFunction',
    'ISpeechLexiconWord', 'ISpeechResourceLoader',
    'DISPID_SPAPhraseInfo', 'SFTSREngine', 'DISPID_SVResume',
    'SVP_16', 'SVEStartInputStream', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SOTCEnumerateTokens', 'SAFTADPCM_11kHzMono',
    'SpeechVisemeFeature', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRGCommit', 'DISPID_SPACommit', 'SP_VISEME_7',
    'SPCT_DICTATION', 'SpInprocRecognizer',
    'DISPID_SRCEPropertyNumberChange', 'SpeechRecoProfileProperties',
    'DISPID_SGRsCount', 'DISPID_SLPSymbolic',
    'DISPID_SpeechBaseStream', 'SPEI_RECO_STATE_CHANGE', 'SASPause',
    'ISpeechPhraseInfo', 'ISpRecognizer', 'SRERecoOtherContext',
    'DISPID_SRGReset', 'SAFT8kHz16BitStereo', 'STCAll', 'SDTRule',
    'DISPID_SRCEEndStream', 'DISPID_SRCCreateResultFromMemory',
    'ISpeechRecognizerStatus', 'SPSERIALIZEDPHRASE',
    'SpeechGrammarState', 'ISpeechPhoneConverter',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFT24kHz8BitStereo',
    'DISPID_SOTsItem', 'DISPID_SPRuleFirstElement', 'ISpRecoResult',
    'SPRULE', 'ISpeechCustomStream', 'SLODynamic', 'SPEI_RESERVED1',
    'SPWORD', 'SAFT8kHz8BitMono', 'SPINTERFERENCE_TOOLOUD',
    'SITooFast', 'DISPID_SpeechRecoResult2', 'ISpeechPhraseRules',
    'eLEXTYPE_PRIVATE7', 'DISPID_SOTCreateInstance',
    'SAFT11kHz8BitStereo', 'SPFILEMODE', 'eLEXTYPE_USER_SHORTCUT',
    'IEnumSpObjectTokens', 'DISPID_SGRSTPropertyName',
    'DISPID_SpeechLexiconWord', 'SAFTCCITT_ALaw_8kHzMono',
    'SpNotifyTranslator', 'DISPID_SPPBRestorePhraseFromMemory',
    'SpeechAudioState', 'DISPID_SpeechGrammarRule',
    '_ISpeechVoiceEvents', 'SPPS_RESERVED3', 'ISpRecognizer3',
    'DISPID_SRSetPropertyString', 'SPFM_CREATE_ALWAYS',
    'DISPID_SDKEnumKeys', 'DISPID_SpeechObjectTokens',
    'SAFTCCITT_uLaw_11kHzMono', 'SECFDefault', 'SPPS_Function',
    'SPEI_MAX_SR', 'DISPID_SAFSetWaveFormatEx',
    ...
    'DISPIDSPTSI_ActiveOffset', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpeechVoice', 'SVP_3', 'DISPID_SLPsCount',
    'SAFT12kHz16BitStereo', 'DISPID_SWFEBlockAlign',
    'DISPID_SpeechXMLRecoResult', 'SP_VISEME_18', 'SPPS_Unknown',
    'SSSPTRelativeToStart', 'DISPID_SRCRecognizer',
    'DISPID_SPIAudioSizeBytes', 'SpMMAudioEnum',
    'SpeechDataKeyLocation', 'ISpObjectTokenCategory',
    'DISPID_SOTCDefault', 'DISPID_SPIRetainedSizeBytes',
    'eLEXTYPE_PRIVATE15', 'SPEI_SOUND_END', 'SSFMOpenReadWrite',
    'DISPID_SpeechRecoResultTimes', 'SPAS_RUN',
    'DISPID_SpeechPhraseAlternate', 'SpLexicon', 'SREStateChange',
    'ISpeechPhraseProperty', 'SpeechUserTraining',
    'ISpeechRecoResultDispatch', 'SpeechEngineConfidence',
    'DISPID_SLGetWords', 'DISPID_SMSGetData', 'DISPID_SVEPhoneme',
    'ISpeechPhraseElement', 'ISpeechGrammarRules', 'SGSExclusive',
    'SRATopLevel', 'SAFTGSM610_22kHzMono', 'DISPID_SABufferInfo',
    'SpeechVoiceEvents', 'SP_VISEME_16', 'DISPID_SPEsItem',
    'DISPID_SMSALineId', 'Speech_Max_Pron_Length',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SOTCSetId',
    'DISPID_SPIRule', 'DISPID_SRSClsidEngine',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPSUnknown',
    'tagSPPROPERTYINFO', 'SAFT11kHz16BitStereo', 'DISPID_SPPChildren',
    'ISpRecoGrammar', 'SPEI_WORD_BOUNDARY', 'ISpeechDataKey',
    'SGSEnabled', 'ISpeechObjectTokenCategory',
    'DISPID_SRCESoundStart', 'ISpEventSink', 'DISPID_SPRulesItem',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechAudioBufferInfo',
    'SRCS_Disabled', 'ISpeechRecoContext', 'SAFTADPCM_11kHzStereo',
    'SECHighConfidence', 'SPSModifier', 'SPPROPERTYINFO',
    'DISPID_SVSInputWordPosition', 'SREBookmark', 'DISPIDSPTSI',
    'DISPID_SRRRecoContext', 'SPSVerb',
    'DISPID_SpeechPhraseReplacements', 'ISpeechPhraseReplacement',
    'UINT_PTR', 'ISpeechBaseStream',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SWFEFormatTag', 'SVPAlert', 'Speech_Max_Word_Length',
    'DISPID_SVPriority', 'SpeechWordType', 'SPRECOSTATE',
    'SPEI_SR_BOOKMARK', 'SPCT_SUB_DICTATION',
    'DISPID_SPPFirstElement', 'IInternetSecurityMgrSite',
    'SPDATAKEYLOCATION', 'SPDKL_DefaultLocation',
    'DISPID_SPCPhoneToId', 'SPPHRASERULE', 'SPEI_REQUEST_UI',
    'SPAS_CLOSED', 'SpeechMicTraining', 'SPWT_PRONUNCIATION',
    'DISPID_SPRuleName', 'eLEXTYPE_PRIVATE14', 'SINoSignal',
    'SPINTERFERENCE_NONE', 'SpTextSelectionInformation',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechGrammarRules',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SABIMinNotification',
    'SVSFNLPSpeakPunc', 'SAFTCCITT_ALaw_11kHzMono',
    'SpeechGrammarTagUnlimitedDictation', 'SVSFParseAutodetect',
    'STCRemoteServer', 'SRTAutopause', 'SPWF_INPUT',
    'SPEI_PROPERTY_NUM_CHANGE', 'SGLexical', 'SPPS_RESERVED2',
    'ISpPhrase', 'DISPID_SPANumberOfElementsInResult', 'SVP_0',
    'SVP_18', 'SAFT44kHz8BitMono', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SOTRemove', 'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SBSRead',
    'SDTReplacement', 'SPSMF_SAPI_PROPERTIES', 'SPAS_PAUSE',
    'eLEXTYPE_PRIVATE11', 'SECNormalConfidence', 'SP_VISEME_12',
    'SpeechRetainedAudioOptions', 'eLEXTYPE_PRIVATE2',
    'DISPID_SpeechRecognizer', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRSTPropertyValue', 'SPAUDIOSTATUS', 'ISpPhraseAlt',
    'SBONone', 'DISPID_SRGCmdSetRuleIdState', 'SAFTADPCM_44kHzMono',
    'DISPID_SOTIsUISupported', 'SAFTADPCM_22kHzMono',
    'SPINTERFERENCE', 'SPCS_ENABLED', 'SRSInactive',
    'DISPID_SRRTOffsetFromStart', 'SpUnCompressedLexicon', 'SVP_12',
    'SPEI_VOICE_CHANGE', 'SSTTWildcard', 'SGSDisabled',
    'DISPID_SPIAudioStreamPosition', 'SPRECOCONTEXTSTATUS',
    'SP_VISEME_6', 'DISPID_SGRSTsItem', 'ISpeechRecoResult',
    'SpStream', 'SpeechTokenValueCLSID', 'eLEXTYPE_PRIVATE20',
    'SP_VISEME_17', 'SRARoot', 'SRERequestUI',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVEStreamStart',
    'SpObjectToken', 'DISPID_SLPsItem', 'SPEI_UNDEFINED',
    'SAFT48kHz16BitMono', 'SPWORDTYPE', 'DISPID_SGRsFindRule',
    'SAFT12kHz8BitMono', 'SpeechVisemeType', 'DISPID_SPCIdToPhone',
    'DISPID_SRCEHypothesis', 'SPINTERFERENCE_LATENCY_WARNING',
    'SP_VISEME_19', 'DISPID_SAFType', 'SAFTCCITT_ALaw_44kHzStereo',
    'eWORDTYPE_ADDED', 'SGDSActive', 'DISPID_SOTCId', 'SVP_20',
    'DISPID_SOTGetStorageFileName', 'SECFIgnoreWidth',
    'DISPID_SDKSetLongValue', 'SpPhoneConverter', 'SPPS_Noun',
    'DISPID_SBSSeek', 'DISPID_SAFGuid', 'SPTEXTSELECTIONINFO',
    'SpeechPropertyResponseSpeed', 'SVSFParseMask',
    'DISPID_SOTGetAttribute', 'SpeechSpecialTransitionType',
    'DISPID_SpeechAudioStatus', 'SPAR_Low', 'DISPID_SLWs_NewEnum',
    'DISPID_SBSWrite', 'DISPID_SVSpeakCompleteEvent',
    'STSF_CommonAppData', 'SVEWordBoundary',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRGetPropertyString',
    'SPSNoun', 'DISPID_SRCERecognition', 'SPVPRIORITY',
    'SP_VISEME_13', 'SREAudioLevel', 'SPSEMANTICERRORINFO',
    'DISPID_SpeechPhraseElements', 'DISPID_SpeechAudioFormat',
    'SpVoice', 'SPWF_SRENGINE', 'SPLO_STATIC', 'SPSLMA',
    'SRTStandard', 'DISPID_SPRules_NewEnum', 'SPSHT_EMAIL',
    'DISPID_SLAddPronunciation', 'DISPID_SGRsCommitAndSave',
    'SPAO_RETAIN_AUDIO', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRRTStreamTime', 'DISPID_SRCRequestedUIType',
    'DISPID_SPIReplacements', 'DISPID_SOTDisplayUI',
    'DISPID_SPPValue', 'ISpeechPhraseInfoBuilder', 'SRSEDone',
    'DISPIDSPRG', 'DISPID_SPEActualConfidence', 'SVP_2',
    'SREStreamEnd', 'SFTInput', 'DISPID_SpeechPhraseElement',
    'DISPID_SGRsDynamic', 'DISPID_SVVolume', 'DISPID_SDKCreateKey',
    'SPWT_LEXICAL', 'SDA_Consume_Leading_Spaces', 'DISPID_SOTId',
    'DISPID_SGRAddState', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPSMF_UPS',
    'SAFT11kHz8BitMono', 'DISPID_SRRTTickCount',
    'DISPID_SDKGetStringValue', 'SPVPRI_OVER',
    'ISpPhoneticAlphabetConverter', 'SpeechRecognizerState',
    'SAFT32kHz16BitStereo', 'DISPID_SPRFirstElement',
    'DISPID_SPEDisplayText', 'SVP_10', 'DISPID_SAEventHandle',
    'SPRST_INACTIVE_WITH_PURGE', 'SSTTTextBuffer',
    'ISpeechRecoGrammar', 'DISPID_SAStatus',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVIsUISupported',
    'DISPID_SPRs_NewEnum', 'eLEXTYPE_RESERVED10',
    'DISPID_SGRSTsCount', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SAVolume', 'SREHypothesis', 'SPGRAMMARWORDTYPE',
    'DISPID_SpeechRecoContextEvents', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SVWaitUntilDone', 'SpeechLexiconType', 'SPSNotOverriden',
    'DISPID_SRGCmdLoadFromObject', 'SVSFParseSapi',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRSNumberOfActiveRules',
    'SPRST_INACTIVE', 'DISPID_SMSADeviceId',
    'DISPID_SpeechPhoneConverter', 'SAFT22kHz16BitMono',
    'DISPID_SGRs_NewEnum', 'SAFTADPCM_8kHzMono', 'SITooSlow',
    'eLEXTYPE_RESERVED4', 'DISPID_SRRSpeakAudio', 'STCLocalServer',
    ...
    'DISPID_SDKDeleteKey', 'SPEI_SR_PRIVATE', 'DISPID_SVVoice',
    'SAFT44kHz16BitMono', 'DISPID_SVPause', 'DISPID_SVSLastResult',
    'SPPS_Modifier', 'ISpDataKey', 'ISpeechRecoResultTimes',
    'DISPID_SVEBookmark', 'eLEXTYPE_RESERVED6', 'SRADefaultToActive',
    'SAFT48kHz16BitStereo', 'DISPID_SADefaultFormat', 'SP_VISEME_8',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SLPLangId', 'SVF_None',
    'SPLOADOPTIONS', 'DISPID_SPIGetText', 'DISPID_SRCBookmark',
    'SpeechCategoryPhoneConverters', 'DISPID_SPEDisplayAttributes',
    'SpeechRecoEvents', 'DISPID_SBSFormat', 'ISpeechAudioBufferInfo',
    'ISpSerializeState', 'SRAInterpreter', 'SVP_5',
    'SpeechAudioFormatGUIDText', 'SpPhoneticAlphabetConverter',
    'DISPID_SPPName', 'SpeechWordPronounceable',
    'DISPID_SPERetainedStreamOffset', 'SpSharedRecoContext',
    '_SPAUDIOSTATE', '__MIDL_IWinTypes_0009', 'ISpeechPhraseElements',
    'DISPID_SRCERecognizerStateChange', 'SpeechBookmarkOptions',
    'SVP_7', 'SAFT16kHz16BitMono', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRSCurrentStreamPosition', 'SWTAdded',
    'DISPID_SRGIsPronounceable', 'eLEXTYPE_PRIVATE9',
    'SpeechLoadOption', 'SPSInterjection', 'DISPID_SASState',
    'SpNullPhoneConverter', 'SSSPTRelativeToEnd',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVRate', 'ISpNotifySink',
    'DISPID_SRCEInterference', 'SPAUDIOBUFFERINFO',
    'SpeechStreamFileMode', 'SVP_11', 'DISPID_SRCreateRecoContext',
    'SPINTERFERENCE_TOOFAST', 'SPSERIALIZEDRESULT',
    'DISPID_SDKOpenKey', 'SPRST_NUM_STATES',
    'DISPID_SRCEFalseRecognition', 'SREAdaptation', 'SASRun',
    'SPEI_START_INPUT_STREAM', 'ISpeechLexiconPronunciation',
    'ISpeechMMSysAudio', 'SP_VISEME_10', 'SPVPRI_ALERT',
    'SPEI_INTERFERENCE', 'SpeechCategoryRecognizers', 'SRTEmulated',
    'SGDSActiveWithAutoPause', 'ISpeechRecognizer',
    'DISPID_SRRecognizer', 'SAFT8kHz8BitStereo',
    'DISPID_SRRGetXMLErrorInfo', 'STCInprocHandler', 'SPAO_NONE',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRAudioInput', 'SECFIgnoreCase',
    'ISpVoice', 'ISpeechAudioFormat', 'SDA_One_Trailing_Space',
    'DISPID_SLRemovePronunciation', 'DISPID_SVSLastBookmarkId',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVSFlagsAsync',
    'DISPID_SRGDictationSetState', 'IStream', 'SWTDeleted',
    'DISPID_SPIStartTime', 'SpeechGrammarRuleStateTransitionType',
    'eLEXTYPE_PRIVATE19', 'DISPID_SLWWord', 'DISPID_SGRId',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRGetRecognizers',
    'SpWaveFormatEx', 'DISPID_SOTMatchesAttributes',
    'SpeechCategoryAppLexicons', 'SVP_13', 'SPAR_Medium',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SWFEChannels',
    'DISPID_SRCEBookmark', 'SREFalseRecognition', 'DISPID_SMSSetData',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SpeechGrammarRuleState',
    'SpeechTokenShellFolder', 'DISPID_SLWPronunciations',
    'DISPID_SVGetAudioInputs', 'SLTApp', 'SPEI_VISEME',
    'SVSFIsNotXML', 'SGRSTTRule', 'ISpStream', 'SAFT24kHz8BitMono',
    'DISPID_SWFEExtraData', 'SREPrivate', 'DISPID_SVSVisemeId',
    'SRSEIsSpeaking', 'DISPID_SWFEBitsPerSample',
    'DISPID_SDKGetBinaryValue', 'DISPID_SRCERequestUI',
    'SPGS_EXCLUSIVE', 'SAFT44kHz16BitStereo', 'SPLEXICONTYPE',
    'ISpeechLexiconWords', 'SP_VISEME_9', 'ISpMMSysAudio',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRProfile',
    'SAFT32kHz16BitMono', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SPPEngineConfidence', 'SpeechRuleAttributes',
    'SVSFPurgeBeforeSpeak', 'DISPIDSPTSI_SelectionOffset',
    'SPPHRASEREPLACEMENT', 'DISPID_SOTCategory', 'DISPID_SRGRules',
    'SpResourceManager', 'DISPID_SPPParent', 'DISPID_SDKGetlongValue',
    'DISPID_SPRuleParent', 'SPPS_RESERVED4', 'SRSInactiveWithPurge',
    'SGDisplay', 'SAFTADPCM_22kHzStereo', 'DISPID_SLPs_NewEnum',
    'SVF_Stressed', 'SREStreamStart', 'ISpeechAudioStatus',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRGId', 'IEnumString',
    'DISPID_SPRuleChildren', 'DISPID_SGRClear',
    'DISPID_SLGenerationId', 'DISPID_SDKEnumValues',
    'DISPID_SGRSRule', 'SP_VISEME_15', 'SVPNormal',
    'SpeechVoiceCategoryTTSRate', 'SAFT22kHz8BitStereo',
    'eLEXTYPE_PRIVATE18', 'Speech_StreamPos_RealTime', 'SPGS_ENABLED',
    'SWPUnknownWordPronounceable', 'DISPID_SRState',
    'DISPID_SRCVoice', 'DISPID_SOTDataKey', 'SPCS_DISABLED',
    'DISPID_SVGetVoices', 'SAFTGSM610_8kHzMono',
    'ISpeechObjectTokens', 'DISPID_SPIElements',
    'DISPID_SPRuleConfidence', 'DISPID_SpeechCustomStream',
    'SPRECOGNIZERSTATUS', 'DISPID_SpeechPhraseAlternates',
    'ISpeechPhraseReplacements', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRStatus', 'DISPID_SpeechPhraseRules', 'SRTSMLTimeout',
    'eLEXTYPE_USER', 'SAFT12kHz16BitMono', 'SSFMCreateForWrite',
    'DISPID_SVESentenceBoundary', 'SPWORDPRONOUNCEABLE',
    'STSF_LocalAppData', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechMemoryStream', 'SPEVENT', 'DISPID_SPEsCount',
    'SPAR_High', 'SpStreamFormatConverter', 'DISPID_SRCPause',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVEAudioLevel', 'SpeechPartOfSpeech',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SpeechFileStream',
    'SBOPause', 'DISPID_SPEs_NewEnum', 'SPBO_TIME_UNITS',
    'DISPID_SVEEnginePrivate', 'DISPID_SPIAudioSizeTime',
    'SECFNoSpecialChars', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechDictationTopicSpelling', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFTADPCM_44kHzStereo', 'SPCT_SLEEP', 'SRSActive',
    'SPEI_END_SR_STREAM', 'SPEI_RESERVED5', 'SPBINARYGRAMMAR',
    'SAFTTrueSpeech_8kHz1BitMono', 'SDA_Two_Trailing_Spaces',
    'SPEI_MIN_TTS', 'SRCS_Enabled', 'SRAORetainAudio',
    'SPSEMANTICFORMAT', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SOTSetId', 'DISPID_SRCCmdMaxAlternates', 'SP_VISEME_3',
    'DISPID_SRCRetainedAudio', 'SWPKnownWordPronounceable',
    'DISPID_SASFreeBufferSpace', 'SPEI_RESERVED2',
    'SPFM_OPEN_READWRITE', 'SAFT8kHz16BitMono',
    'DISPID_SWFEAvgBytesPerSec', 'SpeechTokenKeyAttributes',
    'SITooLoud', 'SpMMAudioIn', 'SPVISEMES',
    'DISPID_SPIEnginePrivateData', 'SDKLCurrentUser',
    'DISPID_SAFGetWaveFormatEx', 'SPGS_DISABLED',
    'SGDSActiveUserDelimited', 'DISPID_SGRsAdd', 'SPPS_SuppressWord',
    'SPEI_PHRASE_START', 'SpeechRuleState', 'SPLO_DYNAMIC',
    'DISPID_SLPPartOfSpeech', 'ISpLexicon',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SVSpeakStream',
    'SPDKL_CurrentUser', 'DISPID_SRGSetTextSelection', 'SVSFNLPMask',
    'DISPID_SRRTLength', 'DISPID_SpeechMMSysAudio',
    'SpeechAudioProperties', 'ISpeechFileStream',
    'SGLexicalNoSpecialChars', 'SAFT32kHz8BitStereo', 'SPRS_ACTIVE',
    'DISPID_SPEAudioSizeBytes', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRGState', 'SPVPRI_NORMAL', 'DISPID_SVGetProfiles',
    'SDTAll', 'DISPID_SLGetPronunciations', 'LONG_PTR',
    'ISpeechTextSelectionInformation', 'DISPID_SVEStreamEnd',
    'eLEXTYPE_PRIVATE8', 'SDA_No_Trailing_Space', 'SPPHRASE',
    'IInternetSecurityManager', 'DISPID_SRCEAudioLevel',
    'DISPID_SPERequiredConfidence', 'SREInterference', 'SRAONone',
    'ISpPhoneConverter', 'eLEXTYPE_PRIVATE16',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRSAudioStatus',
    'ISpResourceManager', 'SPEI_RESERVED6', 'DISPID_SPIGrammarId',
    'DISPID_SPPs_NewEnum', 'DISPID_SVSInputWordLength',
    'SPCATEGORYTYPE', 'DISPID_SASetState', 'SpeechRegistryUserRoot',
    'DISPID_SVAudioOutputStream', 'ISpeechGrammarRule',
    'ISpeechGrammarRuleStateTransitions', 'ISpProperties',
    'SpeechPropertyResourceUsage', 'DISPID_SVSpeak', 'SPRS_INACTIVE',
    'DISPID_SOTCGetDataKey', 'SGRSTTTextBuffer', 'ISpStreamFormat',
    'DISPID_SGRsCommit', 'SPBO_PAUSE', 'SPEI_RECO_OTHER_CONTEXT',
    'SpeechVoiceSpeakFlags', 'DISPID_SVAudioOutput',
    'DISPID_SpeechLexiconWords', 'DISPID_SVEVoiceChange',
    'DISPID_SPARecoResult', 'SPBO_AHEAD',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SLWLangId',
    'SpeechRecognitionType', 'SVP_8', 'DISPID_SFSClose',
    ...
    'SpAudioFormat', 'SVP_1', 'DISPID_SFSOpen',
    'SpObjectTokenCategory', 'eLEXTYPE_PRIVATE13', 'SVF_Emphasis',
    'DISPID_SpeechDataKey', 'SPCONTEXTSTATE', 'SP_VISEME_14',
    'SPWT_DISPLAY', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCEStartStream', 'SGRSTTDictation',
    'SPEI_SENTENCE_BOUNDARY', 'eLEXTYPE_APP',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechObjectToken',
    'DISPID_SPIProperties', 'SP_VISEME_11', 'SVPOver', 'SRAExport',
    'SpeechAudioVolume', 'DISPID_SPCLangId', 'SGPronounciation',
    'SPSHORTCUTPAIR', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechGrammarWordType', 'SVEAllEvents', 'Speech_Default_Weight',
    'DISPID_SpeechVoiceStatus', 'ISpeechObjectToken',
    'SRSActiveAlways', 'DISPID_SRGDictationUnload',
    'SAFT24kHz16BitMono', 'SPEI_SOUND_START',
    'SpeechGrammarTagWildcard', 'SREPropertyStringChange',
    'DISPID_SLPType', 'SpCustomStream', 'SPXRO_SML', 'SpShortcut',
    'SVEPrivate', 'DISPID_SWFESamplesPerSec',
    'SAFTCCITT_uLaw_8kHzMono', 'SpeechDisplayAttributes',
    'SRESoundStart', 'SPAR_Unknown', 'SpInProcRecoContext',
    'SDTAlternates', 'ISpeechPhraseAlternate',
    'DISPID_SpeechPhraseProperty', 'SPRECORESULTTIMES',
    'SPGRAMMARSTATE', 'SAFT44kHz8BitStereo',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPEI_HYPOTHESIS',
    'eLEXTYPE_PRIVATE4', 'DISPID_SPPsCount', 'SpPhraseInfoBuilder',
    'SVEAudioLevel', 'DISPID_SRIsShared', 'DISPID_SRDisplayUI',
    'DISPID_SRRGetXMLResult', 'SVP_14', 'SAFTGSM610_44kHzMono',
    'DISPID_SVSPhonemeId', 'SDKLLocalMachine', 'SASClosed',
    'SECLowConfidence', 'SPEVENTENUM', 'DISPID_SLWType',
    'DISPID_SABIBufferSize', 'DISPID_SVDisplayUI',
    'DISPID_SRGDictationLoad', 'DISPID_SRCSetAdaptationData',
    'STSF_AppData', 'SPPS_NotOverriden', 'SP_VISEME_1', 'ISpShortcut',
    'ISpRecognizer2', 'ISpEventSource',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVStatus',
    'SpeechAllElements', 'DISPID_SPPId', 'SVP_9',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFT12kHz8BitStereo',
    'ISpeechPhraseAlternates', 'SPPS_LMA', 'ISpAudio', 'SINoise',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVSFIsFilename',
    '_ISpeechRecoContextEvents', 'SREPhraseStart',
    'SAFTCCITT_uLaw_44kHzMono', 'SPPS_Interjection',
    'SAFT24kHz16BitStereo', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPILanguageId', 'SECFEmulateResult', 'SGRSTTWord',
    'ISpRecoCategory', 'SPWORDPRONUNCIATION',
    'DISPID_SpeechRecoResult', 'ISpeechRecoResult2',
    'DISPID_SRCEAdaptation', 'SAFTExtendedAudioFormat',
    'SpeechAudioFormatGUIDWave', 'SPBOOKMARKOPTIONS',
    'SPXMLRESULTOPTIONS', 'SINone', 'SpeechCategoryAudioIn',
    'DISPID_SLWsItem', 'SPEI_MIN_SR', 'DISPID_SGRSTPropertyId',
    'eWORDTYPE_DELETED', 'ISpeechVoiceStatus', 'ISpXMLRecoResult',
    'DISPID_SPAsItem', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SpeechWaveFormatEx',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRRSaveToMemory',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SGRSAddWordTransition',
    'SRAImport', 'SpeechPropertyHighConfidenceThreshold',
    'SpeechStreamSeekPositionType', 'DISPID_SVSkip',
    'SPSSuppressWord', 'SREPropertyNumChange',
    'DISPID_SPEAudioTimeOffset', 'SpMemoryStream', 'ISpRecoContext2',
    'SPADAPTATIONRELEVANCE', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SpeechRecoContext', 'SPEI_START_SR_STREAM',
    'ISpeechGrammarRuleState', 'SVP_21',
    'DISPID_SGRSAddRuleTransition',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRCESoundEnd',
    'SAFTGSM610_11kHzMono', 'DISPID_SpeechVoiceEvent',
    'SAFTCCITT_ALaw_22kHzMono', 'SVEVoiceChange', 'SPVOICESTATUS',
    'DISPID_SGRAddResource', 'SVP_15', 'SDTProperty',
    'SpCompressedLexicon', 'SSFMOpenForRead',
    'SPINTERFERENCE_TOOSLOW', 'SVSFPersistXML',
    'ISpeechGrammarRuleStateTransition', 'SVP_6', 'eLEXTYPE_PRIVATE6',
    'SPSHT_OTHER', 'SVEBookmark', 'SLOStatic', 'SPSHT_Unknown',
    'SPSHORTCUTTYPE', 'DISPID_SVEventInterests', 'SRADynamic',
    'DISPID_SPAStartElementInResult', 'SVP_4', 'DISPID_SVEWord',
    'tagSTATSTG', 'SAFTNonStandardFormat', 'SPBO_NONE',
    'SVEEndInputStream', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SVSRunningState', 'SPPS_Verb', 'tagSPTEXTSELECTIONINFO',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SVSInputSentenceLength', '_RemotableHandle',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRCResume',
    'SDTDisplayText', 'DISPID_SLPPhoneIds', 'ISpRecoGrammar2',
    'DISPID_SDKSetBinaryValue', 'SpeechAudioFormatType',
    'DISPID_SRRAudio', 'eLEXTYPE_PRIVATE3',
    'DISPID_SVSInputSentencePosition', 'SRTReSent',
    'DISPID_SRAudioInputStream', 'SpeechAddRemoveWord',
    'SPEVENTSOURCEINFO', 'SAFTText', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpRecoContext', 'DISPID_SRSSupportedLanguages',
    'SPSTREAMFORMATTYPE', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRRPhraseInfo', 'DISPID_SPERetainedSizeBytes',
    'ISpStreamFormatConverter', 'DISPID_SMSAMMHandle',
    'eLEXTYPE_RESERVED8', 'DISPID_SRCCreateGrammar', 'SPWORDLIST',
    'eLEXTYPE_PRIVATE1', 'DISPID_SOTsCount',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SGRName',
    'DISPID_SPIGetDisplayAttributes', 'SITooQuiet',
    'DISPID_SPRsCount', 'DISPID_SCSBaseStream', 'DISPID_SPPsItem',
    'SSTTDictation', 'ISpeechLexiconPronunciations',
    'DISPID_SGRSTransitions', 'DISPID_SRIsUISupported',
    'DISPID_SPISaveToMemory', 'SPWAVEFORMATTYPE', 'SpeechTokenKeyUI',
    'Speech_StreamPos_Asap', 'SPEI_RECOGNITION', 'DISPID_SpeechVoice',
    'SpeechGrammarTagDictation', 'SPAUDIOSTATE',
    'DISPID_SPRDisplayAttributes', 'SP_VISEME_20', 'DISPID_SGRsItem',
    'SVSFVoiceMask', 'DISPID_SPIEngineId',
    'DISPID_SPEAudioStreamOffset', 'ISpeechWaveFormatEx',
    'SAFT32kHz8BitMono', 'ISpeechAudio', 'ISpeechXMLRecoResult',
    'DISPID_SGRSTText', 'ISpNotifySource', 'SpeechCategoryVoices',
    'DISPID_SVEViseme', 'DISPID_SRCEventInterests',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRSTWeight',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SDKDeleteValue', 'SVESentenceBoundary',
    'SpSharedRecognizer', 'SVP_19', 'SAFTADPCM_8kHzStereo',
    'SpeechPropertyComplexResponseSpeed', 'SVP_17',
    'DISPID_SPEPronunciation', 'SDTPronunciation', 'SDTAudio',
    'SAFTDefault', 'SPCT_COMMAND', 'SAFT11kHz16BitMono',
    'ISequentialStream', 'SAFT22kHz16BitStereo',
    'SAFT48kHz8BitStereo', 'SPEI_RESERVED3',
    'SpeechTokenIdUserLexicon', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRGetFormat', 'eLEXTYPE_RESERVED9', 'SVEViseme',
    'DISPID_SRCEPhraseStart', 'eLEXTYPE_PRIVATE5', 'DISPID_SGRSTType',
    'SPEI_SR_RETAINEDAUDIO', 'SGRSTTEpsilon', 'DISPID_SLWsCount',
    ...
    'SpeechPropertyAdaptationOn', 'SAFTNoAssignedFormat',
    'SpeechTokenKeyFiles', 'DISPID_SPRsItem', 'DISPID_SGRAttributes',
    'DISPID_SpeechPhraseInfo', 'SASStop',
    'ISpPhoneticAlphabetSelection', 'SP_VISEME_4'
]

_check_version('1.2.0', 1666699760.122882)
